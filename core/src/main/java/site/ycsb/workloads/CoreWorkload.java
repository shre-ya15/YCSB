...
public class CoreWorkload extends Workload {
  ...
  public void init(Properties p) throws WorkloadException {
    ...
    if (fieldcount > Integer.MAX_VALUE) {
      throw new WorkloadException("fieldcount cannot exceed " + Integer.MAX_VALUE);
    }
    ...
    long minscanlength =
        Long.parseLong(p.getProperty(MIN_SCAN_LENGTH_PROPERTY, MIN_SCAN_LENGTH_PROPERTY_DEFAULT));
    long maxscanlength =
        Long.parseLong(p.getProperty(MAX_SCAN_LENGTH_PROPERTY, MAX_SCAN_LENGTH_PROPERTY_DEFAULT));
